...
public class Compte extends JFrame implements ActionListener {
	...
	public Compte()
	{
		...
		lblNewLabel.setBounds(105, 94, 60, 14);
		...
		lblNewLabel_2.setBounds(105, 220, 60, 14);
		getContentPane().add(lblNewLabel_2);
		
		JLabel lblNewLabel_3 = new JLabel("Context");
		lblNewLabel_3.setFont(new Font("Tahoma", Font.BOLD, 11));
		lblNewLabel_3.setBounds(105, 285, 46, 14);
		...
		btnADD.setIcon(new ImageIcon("E:\\java(eclipse)\\icon projet\\true-icon2.png.jpg"));
		...
		btnAnnuler.setBounds(282, 340, 121, 29);
		
		
		btnAnnuler.setBackground(Color.WHITE);
		btnAnnuler.setFont(new Font("Tahoma", Font.BOLD, 12));
		btnAnnuler.setIcon(new ImageIcon("E:\\java(eclipse)\\icon projet\\false-icon2.jpg.png"));
		...
		btnRemove.setIcon(new ImageIcon("E:\\java(eclipse)\\icon projet\\sup4-icon.jpg"));
	...
	public void actionPerformed(ActionEvent event) {
		...
		File users=new File ("E:\\ml.txt"); // instancé les fichier a utiliser
